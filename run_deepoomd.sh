...
--train_batch_size=10000 --train_steps=40 --policy_train_steps=400 \
...
--checkpoint_freq=1000000 --max_steps=2000 --graph_def= --path=./testresults2/29_11_2022.06_54_11.0 --verbose=false --cfr_rm_scale=0.1
