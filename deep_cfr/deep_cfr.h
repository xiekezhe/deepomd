...
struct DeepCFRConfig {
  ...
  int memory_size;
  int global_value_memory_size;
  int policy_memory_size;

  double learning_rate;
  double weight_decay;
  int train_batch_size;
  int global_value_batch_size;
  int inference_batch_size;
  int train_steps;
  int global_value_train_steps;
  ...
  json::Object ToJson() const {
    return json::Object({{"game", game},
                         ...
                         {"global_value_memory_size", global_value_memory_size},
                         {"policy_memory_size", policy_memory_size},
                         {"learning_rate", learning_rate},
                         {"weight_decay", weight_decay},
                         {"train_batch_size", train_batch_size},
                         {"global_value_batch_size", global_value_batch_size},
                         {"inference_batch_size", inference_batch_size},
                         {"train_steps", train_steps},
                         {"global_value_train_steps", global_value_train_steps},
